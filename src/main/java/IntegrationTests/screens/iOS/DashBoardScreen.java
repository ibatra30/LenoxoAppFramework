...
public class DashBoardScreen extends GenericMethods {
    ...
    public void scrollToDefaultStore() {
        this.scrollDown(2, 500);
    }
    ...
    public void addQty(String number) {
        this.scrollDownNClick(txt_qty);
        this.enter(txt_qty, "8");
    }

    public void ClickAddToCart() {
        this.WaitTillVisible(btn_AddToCart);
        this.click(btn_AddToCart);
    }
