...
import static utils.InitMethod.LOGFILE_PATH;
import static utils.InitMethod.SUITE_NAME;
...
public class TestNG_ConsoleRunner extends TestListenerAdapter {
    ...
    public void onTestStart(ITestResult tr) {
        if (logFile == null) {
            logFile = LOGFILE_PATH + SUITE_NAME + "-" + new SimpleDateFormat("MM.dd.yy.HH.mm.ss").format(new Date()) + ".log";
        }
